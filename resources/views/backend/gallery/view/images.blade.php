...
<table class="table datatable-responsive">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td><a href="#">{{$item->category->title}}</a></td>
...
<!-- Create Modal -->
<div class="modal fade" id="create" tabindex="-1" role="dialog" aria-labelledby="create new category"
    aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <form action="{{route('gallery.image.store')}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    @include('backend.gallery.view.form')
                </div>
