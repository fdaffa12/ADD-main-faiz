				...
				<tbody>
					<tr>
						...
						<td class="text-default">
							...
							<a href="#">
								<div class="text-muted font-size-sm"><i class="icon-location3 mr-1"></i> Choose From Map</div>
							</a>
						</td>
							...
							<div class="list-icons">
								<div class="dropdown">
									...
									<div class="dropdown-menu dropdown-menu-right">
										...
										<a href="#" class="dropdown-item"><i class="icon-file-text2"></i> Edit Detail</a>
										<div class="dropdown-divider"></div>
										<a href="#" class="dropdown-item"><i class="icon-file-minus"></i> Delete Developer</a>
									</div>
								</div>
							</div>
						</td>
